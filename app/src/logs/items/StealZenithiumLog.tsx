...
import { StealZenithiumRule } from '@gamepark/zenith/rules/effect'
...
export const StealZenithiumLog: FC<MoveComponentProps<MaterialMove>> = (props) => {
  const { context } = props
  const move = props.move as CustomMove
  const { t } = useTranslation()
  const rules = new StealZenithiumRule(context.game as MaterialGame)
