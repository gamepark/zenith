...
import { ConditionalEffect, ConditionType, ExpandedEffect, SpendCreditEffect } from '@gamepark/zenith/material/effect/Effect'
...
export const SpendCreditHeader = () => {
  const { itsMe, name, conditionEffect } = useDoConditionHeaderContext<SpendCreditEffect>()
